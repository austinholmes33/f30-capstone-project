...
book3 = Book("Anna Karenina", "Leo Tolstoy", 864, "A complex novel in eight parts, with more than a dozen major characters, Anna Karenina is often published in more than 800 pages. It deals with themes of betrayal, faith, family, marriage, Imperial Russian society, desire, and rural vs. city life. The story centers on an extramarital affair between Anna and dashing cavalry officer Count Alexei Kirillovich Vronsky.", "http://4.bp.blogspot.com/-TuW3ThIlOVo/T56rSQq9wcI/AAAAAAAAEvM/3LfEYFQkqXI/s1600/anna-karenina.jpg")
